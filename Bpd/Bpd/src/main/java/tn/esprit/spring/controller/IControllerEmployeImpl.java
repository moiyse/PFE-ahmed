...
public class IControllerEmployeImpl  {
	...
	@Autowired
	IBudgetService iibudgetservice;
	...
	public IBudgetService getIibudgetservice() {
		return iibudgetservice;
	}

	public void setIibudgetservice(IBudgetService iibudgetservice) {
		this.iibudgetservice = iibudgetservice;
	}
